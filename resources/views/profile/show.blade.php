            ...
            <div class="lg:mx-auto flex flex-col w-full max-w-lg mb-12 text-center">
                ...
                <div class="mt-4 text-center">
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md bg-neutral-950 px-6 font-medium text-neutral-50">
                            <span class="absolute h-0 w-0 rounded-full bg-sky-500 transition-all duration-300 group-hover:h-56 group-hover:w-32"></span>
